...
const experiences = [
  {
    ...
    period: "2025 — Present",
    description:
      "Founded Symbiothus, an umbrella company for a family of AI, developer, and consumer products — built, shipped, and run end-to-end. Overseeing 11+ products including DuckTap, Anomalithic, Markuce, BirdEye, NutriSnap, and more. Responsible for architecture, development, deployment, and product strategy across the entire ecosystem.",
    highlights: [
  ...
  },
  {
    ...
    period: "2023 — 2025",
    description:
      "Led the development of a government-backed education technology platform from concept to $47,862 in revenue. Built a comprehensive digital learning ecosystem for students across Pakistan, including SLO mapping, AI-powered assistance, and interactive learning tools.",
    highlights: [
  ...
  },
  {
    ...
    period: "2025 — Present",
    description:
      "Freelance work as 'Jolly Roger' on Contra, delivering end-to-end web development, AI agent automation, and creative AI video projects. Clients include Jolly Roger (AI chatbot development) and Big Bites Cafe (full-stack web platform with AI ordering).",
    highlights: [
  ...
  },
  {
    ...
    period: "2025 — Present",
    description:
      "Exploring generative AI filmmaking through a YouTube channel dedicated to experimental short films and video content created with AI tools. Pushing creative boundaries at the intersection of technology and cinema.",
    highlights: [
            ...
            {experiences.map((exp, i) => (
              ...
              >
                <div className="relative pl-6 md:pl-20">
                  {/* Timeline dot */}
                  <div className="absolute left-[-4.5px] top-1 h-2.5 w-2.5 rounded-full border-2 border-brand bg-background md:left-[26.5px]" />

                  <div className="rounded-2xl border border-border bg-surface-card p-6 transition-all duration-[var(--duration-normal)] ease-entrance hover:border-border-hover">
                    <div className="flex flex-col gap-1 md:flex-row md:items-center md:justify-between">
                      <div>
                        <span className="text-xs font-medium uppercase tracking-widest text-brand">
                          {exp.role}
                        </span>
                        <h2 className="mt-1 text-xl font-medium">{exp.company}</h2>
                      </div>
