...
const projects = [
  {
    ...
    description:
      "CLI factory for AI agents — prints Python CLIs, MCP servers, and skills from any OpenAPI spec, HAR file, or website. Published on PyPI. No bespoke code required.",
  ...
  },
  {
    ...
    description:
      "Open-core AI agent runtime with MCP, skills, hooks, multi-agent orchestration, cross-session memory, and a thinking-time ad network with 50/50 stablecoin payouts.",
  ...
  },
  {
    ...
    description:
      "Local-first mission control, collective memory, and MCP gateway for all your AI agent harnesses. Runs as a daemon on 127.0.0.1 with an interactive dashboard. Free, MIT, no cloud, no telemetry.",
  ...
  },
  {
    ...
    description:
      "GitHub issue intake generator that helps open-source maintainers triage, organize, and respond to incoming issues more efficiently.",
  ...
  },
  {
    ...
    description:
      "Agentic AI orchestration platform that lets non-technical people run AI agents with no terminal required. Currently in development.",
  ...
  },
  {
    ...
    description:
      "Fintech payment platform enabling businesses to accept payments in regions and scenarios where traditional processors like Stripe don't operate.",
  ...
  },
  {
    ...
    description:
      "AI-powered nutrition tracking app. Snap a photo of any meal and instantly get calorie counts, macros, and a full nutritional breakdown powered by Google Gemini.",
  ...
  },
  {
    ...
    description:
      "Formerly Vidius — a unified interface for generating images and video across many AI providers. Self-hostable open-source creative studio.",
  ...
  },
  {
    ...
    description:
      "Desktop security application providing zero-knowledge secrets management, built in Rust for maximum performance and safety.",
  ...
  },
  {
    ...
    description:
      "Web3 payment infrastructure for non-custodial stablecoin payments that just settle. Built for the decentralized finance ecosystem.",
    tech: ["Web3", "Stablecoins", "Payments", "Blockchain"],
    category: "Fintech",
  },
];

const categories = ["All", "AI / Agents", "Dev Tooling", "Fintech", "Consumer", "AI Media", "Security"];
      ...
      <section className="mx-auto max-w-content px-6 pb-20 md:px-10 md:pb-28">
        <div className="grid gap-6 md:grid-cols-2">
          {projects.map((project, i) => (
            ...
            >
              <div className="group flex h-full flex-col rounded-2xl border border-border bg-surface-card p-6 transition-all duration-[var(--duration-normal)] ease-entrance hover:border-border-hover hover:bg-surface-card-hover">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <span className="text-xs font-medium uppercase tracking-widest text-brand">
                      {project.category}
                    </span>
                    <h2 className="mt-1 text-xl font-medium">{project.title}</h2>
                  </div>
                </div>
